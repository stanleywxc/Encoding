========================================================================
    ACTIVE TEMPLATE LIBRARY : Proxy.COM Project Overview
========================================================================

AppWizard has created this Proxy.COM project for you to use as the starting point for
...
_ProxyCOM.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Proxy.COM.h)
        GUID definitions                                (_Proxy.COM_i.c)
        A type library                                  (_ProxyCOM.tlb)
        Marshaling code                                 (_Proxy.COM_p.c and dlldata.c)
Proxy.COM.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Proxy.COM.pch and a precompiled types file named StdAfx.obj.
...
Proxy.COMps.vcproj
	...
	dlldata.c, Proxy.COM_i.c and Proxy.COM_p.c which are required
